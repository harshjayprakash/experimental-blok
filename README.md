...
It was originally a way to learn C, though originally written in C++, and the Windows API,
from February of 2021. _Not on GitHub at the time_. It had no goals nor direction. The
"Blok" was an accidental misspelling of the block, as at the time I called it the "C
Project". It simply could render a rectangle that could move around a native window but
would leave a tail behind, due to the lack of updating the window.
