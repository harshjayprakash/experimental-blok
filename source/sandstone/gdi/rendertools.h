 ...
 *
 * @details
 * This function contains all the rendering tools required for painting the user
 * interface. The default configuration for HBRUSH is creating a solid brush based on the
 * theme palette. HPEN follows the same principle with the PS_SOLID and 1 as the
 * thickness.
 */
 ...
 *
 * @details
 * This function attempts to create all the brushes and pens. 
 *
 * @param[out] pTools     Pointer to the render tools.
 * @param[in]  pColours   Pointer to the theme palette.
 ...
 *
 * @details
 * This function frees all the allocated brushes and pens.
 *
 * @param[out] pTools   Pointer to the render tools.
 * @return `1` for success, `0` for failure.
 *
